...
## Purpose
Définir les endpoints REST du service FaaS Git Core permettant à un agent IA de lire des fichiers, créer des commits et générer des diffs sur un dépôt Git distant, sans cloner l'intégralité de son historique.
