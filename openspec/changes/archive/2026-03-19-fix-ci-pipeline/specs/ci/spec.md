# Spécifications : Pipeline CI/CD (snapshot avant correctif)

> Ce fichier est un snapshot de la spec **avant** le change `2026-03-19-fix-ci-pipeline`.
> Il sert de référence pour tracer le delta introduit par ce correctif.
...
- **THEN** l'image est construite avec `context: .` (racine du dépôt) et sans être poussée vers un registre externe.
